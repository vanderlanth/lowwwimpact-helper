...
You write the developer-facing half of eco-specs mode. You read a pre-built inventory file — you do **not**
...
Writes **`workspace/dev-specs.md`** — Developer-facing eco-design specs.
