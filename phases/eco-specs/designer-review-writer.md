...
You write the designer-facing half of eco-specs mode. You read a pre-built inventory file — you do **not**
...
Writes **`workspace/eco-review.md`** — Designer-facing per-screen review.
...
Save to `workspace/eco-review.md`:
...
*Generated by lowwwimpact-helper eco-specs · [model-id] · Screens analyzed: N · ~X tokens · ~$X*
```
